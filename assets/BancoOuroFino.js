...
var extrato = ["Foi sacado 520 reais", "\nFoi transferido 200 reais para a conta (358964)"]; //Extrato


function boas_vindas() {
	var user = prompt("Insira seu nome:");
	alert(`Olá, ${user}! Seja bem-vindo(a) ao Banco Ouro Fino!`);
	inicio();
}
...
function fazer_transferencia() {
	...
	var transferencia = parseFloat(prompt('Insira a quantia que deseja transferir:'))
